...
<form action="insert.php" onsubmit="return validate(this)" method="post">
  <div class="container">
    ...
    <hr>
      ...
      <input type="text" placeholder="Enter Team name" name="Player1" >

      <label for="CID"><b>Character ID</b></label>
      <input type="tel" placeholder="Enter Character ID" name="CID" required>

      <label for="phone"><b>Phone</b></label>
      <input type="tel" placeholder="Enter Phone no." name="phnum" required>

      <a href="games.html" id="login-register-butons">Cancel</a>
      <br>
      <br>
      <br>
     <footer>
