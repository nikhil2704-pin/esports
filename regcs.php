...
<section id="hero-imgs">
<form action="contd.php" onsubmit="return validate(this)" method="post">
  <div class="container">
    <h1>Register</h1>
    <p>Please fill in this form to create an account.</p>
    <hr>
      <label for="Player1"><b>Team name</b></label>
      <input type="text" placeholder="Enter Team name" name="teamname" >

      <label for="CID"><b>Character ID</b></label>
      <input type="tel" placeholder="Enter Character ID" name="CID" required>

      <label for="phone"><b>Phone</b></label>
      <input type="tel" placeholder="Enter Phone no." name="phone" required>
      <input type="submit" name="submit" id="login-register-buttons" value="Register" >
