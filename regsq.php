...
<section id="heroo-img">
<form action="consq.php" method="post">
  <div class="container">
    <h1>Register</h1>
...
<p>Player3</p>
<input type="text" name="Player3" placeholder="Enter Player3">
<p>CID</p>
<input type="number" name="CID3" placeholder="Enter Character ID">
<p>Player4</p>
<input type="text" name="Player4" placeholder="Enter Player4">
<p>CID</p>
<input type="number" name="CID4" placeholder="Enter Character ID">
<p>phone</p>
